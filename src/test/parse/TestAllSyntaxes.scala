...
class TestAllSyntaxes extends FunSuite {
  ...
  val COMMANDS = """|_ask agent or agentset/command block,OTPL,Some(?),0,2,2
                    ...
                    |_face turtle or patch,-T--,None,0,1,1
                    |_facexy number/number,-T--,None,0,2,2
                    ...
                    |_outputwrite anything,OTPL,None,0,1,1
                    ...
                    |_write anything,OTPL,None,0,1,1""".stripMargin.replaceAll("\r\n", "\n")
}
